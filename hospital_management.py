...
class HospitalApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        # Bind the selection event to fill entry fields
    ...
    def on_tree_select(self, event):
        ...
        self.entry_name.insert(0, hospital_data[0])  # Hospital Name
        self.entry_address.delete(0, tk.END)
        self.entry_address.insert(0, hospital_data[1])  # Hospital Address
