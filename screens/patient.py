...
class Database:
    def __init__(self):
        self.dbConnection = sqlite3.connect("DB/patient.db")
...
class InsertWindow:
    def __init__(self):
        ...
        tkinter.Label(self.window, text = "Day Of Birth",  width = 25).grid(pady = 5, column = 1, row = 4)
...
class HomePage:
    def __init__(self):
        ...
        self.homePageWindow.configure(bg="light blue")
        ...
        tkinter.Button(self.homePageWindow, width = 20, text = "Insert", relief="flat",activebackground="#BCD4E6",activeforeground="white",font=("times",12),cursor="circle",state="normal", command = self.Insert).grid(pady = 15, column = 1, row = 2)
        tkinter.Button(self.homePageWindow, width = 20, text = "Update", relief="flat",activebackground="light pink",activeforeground="white",font=("times",12),cursor="circle",state="normal", command = self.Update).grid(pady = 15, column = 1, row = 3)
        tkinter.Button(self.homePageWindow, width = 20, text = "Search", relief="flat",activebackground="#BCD4E6",activeforeground="white",font=("times",12),cursor="circle",state="normal", command = self.Search).grid(pady = 15, column = 1, row = 4)
        tkinter.Button(self.homePageWindow, width = 20, text = "Delete", relief="flat",activebackground="light pink",activeforeground="white",font=("times",12),cursor="circle",state="normal", command = self.Delete).grid(pady = 15, column = 1, row = 5)
        tkinter.Button(self.homePageWindow, width = 20, text = "Display", relief="flat",activebackground="#BCD4E6",activeforeground="white",font=("times",12),cursor="circle",state="normal", command = self.Display).grid(pady = 15, column = 1, row = 6)
        tkinter.Button(self.homePageWindow, width = 20, text = "Exit", relief="flat",activebackground="light pink",activeforeground="white",font=("times",12,"underline"),cursor="circle",state="normal", command = self.homePageWindow.destroy).grid(pady = 15, column = 1, row = 7)
